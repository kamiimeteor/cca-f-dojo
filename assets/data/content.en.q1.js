...
w:{0:'That truncates unfinished work.',2:'A retry does not advance the loop.',3:'Inspecting assistant text is an anti-pattern.'}},
...
w:{0:'That is an explicit anti-pattern.',2:'stop_reason is a structured signal — it is the most reliable thing available.',3:'Iteration count is unrelated to tools per turn.'}},
...
w:{1:'Not the core architectural issue.',2:'This is an architecture principle, not a support limitation.',3:'Performance is not the concern.'}},
...
w:{1:'Tools are not the cause of duplication.',2:'Parallelism is fine; the overlap is the problem.',3:'Unrelated to duplicated content.'}},
...
w:{1:'Loses specialisation and isolation.',2:'Treats the symptom.',3:'Caching does not stop unnecessary invocations.'}},
...
w:{0:'Do not ship a known gap you can close.',2:'Pushes the work back to the user.',3:'Wasteful and untargeted.'}},
...
w:{1:'Unrelated to context inheritance.',2:'A bad allowedTools stops spawning entirely, not context.',3:'Affects output length, not input background.'}},
...
w:{0:'Enumerating branches is impossible and brittle.',2:'Does not address rigidity.',3:'Relocating the text changes nothing.'}},
...
w:{0:'A prompt is only probabilistic advice.',2:'Few-shot raises the odds but guarantees nothing.',3:'Also just a probabilistic hint.'}},
...
w:{0:'Poor experience and unmet needs.',2:'"Several issues at once" is explicitly NOT a reason to escalate.',3:'Slow and fragmented.'}},
...
w:{0:'There is no result yet before execution.',2:'Probabilistic and wastes tokens.',3:'There may be no alternative tool, and a hook generalises.'}},
...
w:{0:'Latency is not the real risk.',2:'Not a naming problem.',3:'Not a meaningful constraint.'}},
...
w:{0:'Attention dilution is not a window-size problem.',2:'Pushes the burden onto the developer; not an architectural fix.',3:'Misses real issues.'}},
...
w:{0:'Dynamic decomposition suits open-ended exploration.',2:'That is for branching comparisons.',3:'That is for self-review gap filling.'}},
...
w:{0:'A fixed pipeline cannot handle the unknown.',2:'Unrelated to decomposition.',3:'Unrelated to decomposition.'}},
...
w:{0:'That is --resume.',2:'Not a CI parallelism mechanism.',3:'That is a new session.'}},
...
w:{0:'Few-shot is not a cure-all; naming problems get renamed.',2:'Treats the symptom; the root cause remains.',3:'Merging creates an over-general tool and makes it worse.'}},
...
w:{0:'No description can paper over mixed responsibilities.',2:'Forcing a call does not help it pick correctly.',3:'Formatting is not the issue.'}},
...
w:{0:'Pushes complexity onto the model.',2:'Remedial after the fact; still wastes calls.',3:'Probabilistic improvement; the design flaw remains.'}},
...
w:{0:'A retry can collide again.',2:'Shrinking the window does not remove it.',3:'Detection is not a fix.'}},
...
w:{0:'Retrying "0 results" is pointless.',2:'A timeout means a data gap; it is not a success.',3:'Excessive escalation.'}},
...
w:{0:'A timeout does not mean the query itself is invalid.',2:'Unrelated to length.',3:'Omitting it sends you back to guessing — exactly what this avoids.'}},
...
w:{0:'It may not call anything.',1:'It may call the wrong tool.',3:'A prompt is probabilistic advice.'}},
...
w:{0:'Violates least privilege and inflates the tool count, hurting selection accuracy.',2:'Breaks hub-and-spoke.',3:'Loses central orchestration.'}},
...
w:{0:'Reinventing the wheel.',2:'No community server will exist for a proprietary internal process.',3:'Throws away the reuse benefit of standardisation.'}},
...
w:{0:'Inefficient and may still not be unique.',2:'Bypasses the tool layer and is risky.',3:'Leaves the task unfinished.'}},
...
w:{0:'Context explosion plus mountains of irrelevant material.',2:'Structure without semantics.',3:'Speculation introduces hallucination.'}},
